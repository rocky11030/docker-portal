...
CREATE TABLE `User` (
  ...
  `secretKey` varchar(255) DEFAULT NULL COMMENT '密钥',
  `status` int(11) DEFAULT NULL COMMENT '用户状态 0申请、1有效、2暂停、3无效',
  `userType` int(11) DEFAULT NULL COMMENT '用户类型  占不用',
